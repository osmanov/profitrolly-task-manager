      ...
      {!portfolios || portfolios.length === 0 ? (
        ...
        <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-3">
          {portfolios.map((portfolio) => (
            <Card key={portfolio.id} className="hover:shadow-md transition-shadow" data-testid={`card-portfolio-${portfolio.id}`}>
              <CardHeader>
                <CardTitle className="text-base" data-testid={`text-portfolio-name-${portfolio.id}`}>
                  {portfolio.name}
                </CardTitle>
              </CardHeader>
              <CardContent>
                ...
                <div className="flex space-x-2">
                  <Link href={`/portfolios/${portfolio.id}`}>
                    <Button variant="outline" size="sm" data-testid={`button-edit-${portfolio.id}`}>
